...
import { 
  ...
  CreditCard, ExternalLink, Globe, Info
} from 'lucide-react'
        ...
        {loadingPlatforms ? (
          ...
          <div className="flex flex-col lg:flex-row gap-8 items-start">
            ...
            <div className="w-full lg:w-3/5 bg-white border border-slate-100 rounded-[2.5rem] p-8 md:p-10 shadow-[0_20px_50px_-15px_rgba(0,0,0,0.04)] space-y-8">
              ...
              {/* ========================================= */}
              {/* PAYMENT GATEWAY PANEL (۴ درگاه پادشاهی)      */}
              {/* ========================================= */}
                ...
                <div className="pt-6 border-t border-slate-100 space-y-4 animate-fade-in-up">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div className="border border-slate-200 rounded-2xl p-5 flex items-center justify-between opacity-50 bg-slate-50 cursor-not-allowed">
                      <div className="flex items-center gap-3">
                        <div className="p-3 bg-slate-200 text-slate-500 rounded-xl"><CreditCard className="w-5 h-5" /></div>
                        <div>
                          <p className="text-sm font-black text-slate-800">Credit / Debit Card</p>
                          <p className="text-[10px] font-bold text-slate-400">Visa, Mastercard networks</p>
                        </div>
                      </div>
                    ...
                    <div className="border border-slate-200 rounded-2xl p-5 flex items-center justify-between opacity-50 bg-slate-50 cursor-not-allowed">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-[10px] font-bold text-slate-400">International dynamic checkout</p>
                        </div>
                      </div>
                      <span className="text-[9px] font-black bg-slate-300 text-slate-600 px-2 py-0.5 rounded-md uppercase">Soon</span>
                    </div>
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="text-[10px] font-bold text-slate-400">Premium decentralized infrastructure</p>
                      </div>
                    </button>
                  </div>
