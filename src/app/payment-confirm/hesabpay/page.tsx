...
function HesabPayCheckoutContent() {
  ...
  const copyToClipboard = () => {
    navigator.clipboard.writeText(HESABPAY_NUMBER)
    setCopied(true)
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    formData.append('gateway', 'HesabPay')

    try {
      const res = await fetch('/api/webhook/hesabpay', {
        method: 'POST',
        body: formData,
      })
        ...
        <div className="w-full md:w-2/5 bg-gradient-to-br from-blue-700 to-blue-900 p-8 md:p-10 text-white relative overflow-hidden flex flex-col justify-between">
          ...
          <div>
            ...
            <div className="flex items-center gap-3 mb-8">
              ...
              <div>
                <h1 className="text-2xl font-black text-white leading-none">HesabPay</h1>
                <p className="text-blue-200 text-[10px] font-bold uppercase tracking-widest mt-1">Manual Checkout</p>
              </div>
            </div>
            ...
            <div className="space-y-2">
              <p className="text-blue-200 text-[10px] font-black uppercase tracking-widest">Transfer to Number</p>
              <div className="flex items-center justify-between bg-slate-900/40 border border-white/10 rounded-xl p-4">
                <span className="text-xl font-black text-white tracking-wider">{HESABPAY_NUMBER}</span>
                <button 
                  onClick={copyToClipboard} 
                  className={`p-2.5 rounded-lg transition-all flex items-center gap-2 text-xs font-bold ${
              ...
              <div className="space-y-6">
                ...
                <div className="bg-blue-50/50 border border-blue-100 rounded-2xl p-5">
                  ...
                  <p className="text-slate-600 font-medium text-sm leading-relaxed mb-2">
                    Please transfer the exact amount (in USD or AFN) to the HesabPay number. 
                ...
                <div className="bg-sky-50/50 border border-sky-100 rounded-2xl p-5 text-right" dir="rtl">
                  ...
                  <p className="text-slate-600 font-medium text-sm leading-relaxed mb-2">
                    لطفاً مبلغ دقیق (دلار یا افغانی) را به شماره حساب‌پی ارسال کنید.
